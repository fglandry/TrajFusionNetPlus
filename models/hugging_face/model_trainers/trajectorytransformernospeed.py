...
class TrajectoryTransformerNoSpeed(HuggingFaceTimeSeriesModel):
    ...
    def train(self,
        ...
        encoder_input_size = 4 # data_element.shape[-1]
...
def load_pretrained_trajectory_transformer(dataset_name: str,
    ...
    config_for_trajectory_predictor = get_config_for_timeseries_lib(
        encoder_input_size=4, seq_len=15, hyperparams={}, pred_len=60)
