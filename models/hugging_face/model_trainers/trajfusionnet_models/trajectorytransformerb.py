...
def load_pretrained_encoder_transformer(dataset_name: str,
    ...
    if submodels_paths:
        ...
        if dataset_name in ["pie", "combined"]:
            checkpoint = "data/models/pie/TrajFusionNet/TrajectoryTransformerb/weights_trajectorytransformerb_pie"
        elif dataset_name == "jaad_all":
            checkpoint = "data/models/jaad_all/TrajFusionNet/TrajectoryTransformerb/weights_trajectorytransformerb_jaadall"
        elif dataset_name == "jaad_beh":
            checkpoint = "data/models/jaad_beh/TrajFusionNet/TrajectoryTransformerb/weights_trajectorytransformerb_jaadbeh"
