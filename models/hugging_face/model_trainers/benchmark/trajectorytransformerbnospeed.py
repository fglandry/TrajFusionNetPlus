...
class TrajectoryTransformerbNoSpeed(HuggingFaceTimeSeriesModel):
...
def load_pretrained_encoder_transformer(dataset_name: str,
    ...
    config_for_encoder_tf = get_config_for_timeseries_lib(
            encoder_input_size=4, seq_len=75, hyperparams={})
    if submodels_paths:
        checkpoint = submodels_paths["enc_tf_path"]
    else:
        if dataset_name == "combined":
            checkpoint = "data/models/pie/TrajectoryTransformerbNoSpeed/15Feb2025-21h44m52s_NS1"
            checkpoint = "data/models/combined/TrajectoryTransformerbNoSpeed/30Mar2025-22h04m45s_CO2" # combined
