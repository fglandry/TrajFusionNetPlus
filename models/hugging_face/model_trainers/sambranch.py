...
from models.hugging_face.model_trainers.gambranch import load_pretrained_gam_branch
...
class SAMBranch(HuggingFaceTimeSeriesModel):
    ...
    def test(self,
        ...
        if test_only:
            pretrained_model = load_pretrained_sam_branch(dataset_name)
...
class EncoderTransformer(TimeSeriesTransformerPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs
        ...
        # Add encodings from TokenGT Graph Transformer (GAM branch)
        outputs = []
        ...
        # Duplicate graph encodings along the time timension
        ...
        # Concatenate observed trajectory and predicted trajectory
...
def load_pretrained_sam_branch(dataset_name: str,
